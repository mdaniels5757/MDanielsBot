...
def exif_too_new(file_info):
    ...
    if datetime_str == "0000:00:00 00:00:00":
        return False;
        #datetime_str = "2030:12:25 00:00:00";
    ...
    if original_datetime_str == "0000:00:00 00:00:00":
        #original_datetime_str = "2030:12:25 00:00:00";
        return False;
...
def main():
    ...
    for page in cat.articles():
        ...
        if (migration_redundant(page)):
            ...
            # else (is elgible)
            if (process_orig_upload_date(page.latest_revision) == "eligible" or\
